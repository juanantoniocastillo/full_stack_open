...
test('If like button is clicked twice, the event handler recieves two calls', async () => {
  ...
  blogService.updateLikes.mockResolvedValue({ ...blog, likes: blog.likes + 1 })
  ...
  render(<Blog blog={blog} blogs={blogs} setBlogs={mockSetBlogs} user={blogUser} />)
